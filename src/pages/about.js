...
const AboutPage = () => (
  ...
  <Layout>
    ...
    <div className="page-header">
      ...
      <p>
HiStaff is a service that boost the staff’s productivity by offering new ways
        <br />
        ...
        <div className="row">
          <div className="col-6">
            <div className="item">
              ...
              <p>
Having a human management software for businesses and startups is not always 
                  cost-effective. HiStaff allows companies to archive their employees' 
                  documents and information free of charge.
</p>
            </div>
          </div>
...
How to hold internal events is one of the problems of companies.
                  HiStaff by presenting new ideas allows event management to be done
