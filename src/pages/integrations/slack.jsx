          ...
          <div className="row">
            ...
            <div className="col-6">
              <div className="feature__content">
                ...
                <p>
The ability to send Event alerts to any channel when a new event is created by anyone.
                </p>
              </div>
            </div>
          </div>
...
With the Slack integration, you can send an alert to Slack.
            ...
            <h4>Step 1</h4>
            <p>
Company admin needs to enable the integration one time for the whole company to use.
            </p>
            <img alt="News" src={thumbnailGuid1} />

            <h4>Step 2</h4>
            <p>
Set up your conditions, and press the Update button.
You will be able to send a notification to a specific Slack channel or to a specific user.
            </p>
